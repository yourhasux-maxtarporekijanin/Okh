...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "hasan") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "হাসান")) {
     return api.sendMessage("আমার বস হাসান একটা ভন্ড খোর ওনাকে ডাইকেন না হালায় চিপায় বিজি 😒.!😘",threadID); 
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম হুম করিস না বলদের বাচ্চা হাসানের মাথা এমনিতেই গরম আছে🤬⛏️😷", threadID);
   }; 
